...
/**
 * Home object for domain model class MesaExamenHist.
 * @see ar.com.santalucia.dominio.modelo.academico.MesaExamenHist
 * @author Hibernate Tools
 */
public class MesaExamenHistHome {

	private static final Log log = LogFactory.getLog(MesaExamenHistHome.class);
	...
	public void persist(MesaExamenHist transientInstance) {
		log.debug("persisting MesaExamenHist instance");
		try {
	...
	public void attachDirty(MesaExamenHist instance) {
		log.debug("attaching dirty MesaExamenHist instance");
		try {
	...
	public void attachClean(MesaExamenHist instance) {
		log.debug("attaching clean MesaExamenHist instance");
		try {
	...
	public void delete(MesaExamenHist persistentInstance) {
		log.debug("deleting MesaExamenHist instance");
		try {
	...
	public MesaExamenHist merge(MesaExamenHist detachedInstance) {
		log.debug("merging MesaExamenHist instance");
		try {
	...
	public MesaExamenHist findById(java.lang.Long id) {
		log.debug("getting MesaExamenHist instance with id: " + id);
		try {
			MesaExamenHist instance = (MesaExamenHist) sessionFactory.getCurrentSession()
					.get("ar.com.santalucia.dominio.modelo.academico.MesaExamenHist", id);
			if (instance == null) {
	...
	public List findByExample(MesaExamenHist instance) {
		log.debug("finding MesaExamenHist instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("ar.com.santalucia.dominio.modelo.academico.MesaExamenHist")
