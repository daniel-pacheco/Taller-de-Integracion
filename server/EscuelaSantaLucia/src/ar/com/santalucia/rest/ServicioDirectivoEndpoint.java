...
public class ServicioDirectivoEndpoint {
	 ...
	 * 2) Actualizar datos de alumno que no sean adicionales (teléfono, mail, título y domicilio).<br>
	...
	/**
	 * Utilice este método para eliminar un directivo. Además de eliminar el alumno, también se eliminan los datos adicionales (teléfono, mail y domicilio).
	 * @param id
